...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(14,165,233,0.12),transparent_34%),linear-gradient(180deg,#f7fbfc_0%,#eef5f6_100%)] text-slate-900">
      <Navbar
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 pb-14 pt-8 sm:px-6 lg:px-8">
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,0.9fr)] lg:items-start">
          ...
          <aside className="rounded-[28px] border border-white/70 bg-white/80 p-5 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur-sm sm:p-6">
            ...
            <div className="mt-6 grid gap-3 rounded-3xl bg-slate-950 p-4 text-sm text-white">
        ...
        {isLoading ? (
          <section className="grid gap-4 lg:grid-cols-2">
            {Array.from({ length: lowDataMode ? 3 : 4 }).map((_, index) => (
              <div
                key={index}
                className="overflow-hidden rounded-[28px] border border-white/70 bg-white/85 p-6 shadow-[0_18px_48px_rgba(15,23,42,0.08)]"
              >
